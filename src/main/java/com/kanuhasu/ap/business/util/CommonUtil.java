...
public class CommonUtil {
	...
	public static Long nextRegNo() {
		...
		do {
			...
			/*
			 * we need this, as its likely program executes so fast that, prev and next both
			 * might have the same value.
			 */
			next = next > prev ? next : prev + 1;
		}
		/*
		 * each time we fetch 1 new ID, we update its value in currentTime. And we take
		 * reference of it to make sure, we are threadsafe.
		 * 
		 * compareAndSet will provide a check against stale values. i.e. while updating
		 * currentTime's values, if existing copied value of currentTime isnt same as
		 * the current value of currentTime, some other thread already have taken the
		 * nextID.
		 */
	...
	/**
	 * It builds date given minimum year. Works on date format of yyyy-MM-dd
	 * HH:mm:ss
	 * 
	 * Example: 2017 ==> 2017-01-01 00:00:00 2017-02 ==> 2017-02-01 00:00:00
	 * 2017-02-22 ==> 2017-02-22 00:00:00 2017-02-22 11:00:00 ==> 2017-01-01
	 * 11:00:00 2017-02-22 11:11:00 ==> 2017-01-01 11:11:00 2017-02-22 11:11:11 ==>
	 * 2017-01-01 11:11:11
	 * 
	 * @param fullDateStr
	 * @param criteria
	...
	public static Response processDate(String fullDateStr) throws ParseException {
		...
		if (StringUtils.isNotEmpty(fullDateStr)) {
			...
			/** process date **/
			// "fullDateEle[0]" should at least having the "date-part" and this date-part
			// should at least year in it.
	...
	public static boolean isIdDefined(long id) {
		boolean isIdDefined = true;
		if (id == 0) {
			isIdDefined = false;
		}
		return isIdDefined;
